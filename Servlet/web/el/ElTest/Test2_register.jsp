...
<body>
<form name="form1" method="post" action="Test2_deal.jsp">
<table width="400" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="160" align="center">用&nbsp;户&nbsp;名：</td>
    <td width="240">
      <input name="user" type="text" id="user">    </td>
  </tr>
  <tr>
    <td align="center">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
    <td><input name="pwd1" type="password" id="pwd"></td>
  </tr>
  <tr>
    <td align="center">确认密码：</td>
    <td><input name="pwd2" type="password" id="pwd1"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="affect" type="checkbox"  value="游泳">
      游泳
      <input name="affect" type="checkbox"  value="旅游">
      旅游
      <input name="affect" type="checkbox"  value="看书">
      看书
      <input name="affect" type="checkbox"  value="唱歌">
      唱歌</td>
  </tr>
  <tr>
